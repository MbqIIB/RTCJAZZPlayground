...
public class ChangesetCurrentCmdOptions
  implements IOptionSource
{
  public ChangesetCurrentCmdOptions() {}
    ...
    throws ConflictingOptionException
  {
    ...
    opts.addOption(ChangesetCommonOptions.OPT_CHANGESET, Messages.ChangesetCompleteCmdOptions_OPT_CHANGESET_HELP);
