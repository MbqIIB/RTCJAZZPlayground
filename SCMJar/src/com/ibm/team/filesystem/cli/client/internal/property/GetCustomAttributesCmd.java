  ...
  implements IOptionSource
{
    ...
    throws ConflictingOptionException
  {
    ...
    options
      ...
      .addOption(new ContinuousGroup()
      .addOption(ShowCustomAttributesCmd.OPT_FILE, Messages.ExtendedPropertyGetCmd_FilesHelp, true)
      .addOption(CommonOptions.OPT_DIRECTORY, CommonOptions.OPT_DIRECTORY_ROOT_HELP, false))
      .addOption(new ContinuousGroup()
      .addOption(ShowCustomAttributesCmd.OPT_STREAM, Messages.GetCustomAttributesCmdOptions_STREAM_HELP, true))
      .addOption(new ContinuousGroup()
      .addOption(ShowCustomAttributesCmd.OPT_SNAPSHOT, Messages.GetCustomAttributesCmdOptions_SNAPSHOT_HELP, true)
      .addOption(ShowCustomAttributesCmd.OPT_SNAPSHOT_WORKSPACE, Messages.SnapshotPropertiesCmdOptions_WORKSPACE_HELP, false))
      .addOption(new ContinuousGroup()
      .addOption(ShowCustomAttributesCmd.OPT_BASELINE, Messages.GetCustomAttributesCmdOptions_BASELINE_HELP, true)
      .addOption(ShowCustomAttributesCmd.OPT_BASELINE_COMPONENT, Messages.BaselinePropertiesCmdOptions_COMPONENT_HELP, false))
      .addOption(new ContinuousGroup()
      .addOption(ShowCustomAttributesCmd.OPT_COMPONENT, Messages.GetCustomAttributesCmdOptions_COMPONENT_HELP, true));
    return options;
  }
  ...
  public void run() throws FileSystemException
  {
    ...
    if (count > 1) {
      throw StatusHelper.argSyntax(NLS.bind(Messages.Common_SPECIFY_1_OF_4_ARGUMENTS, 
        new String[] { ShowCustomAttributesCmd.OPT_STREAM.getName(), ShowCustomAttributesCmd.OPT_SNAPSHOT.getName(), 
    ...
    if (cli.hasOption(ShowCustomAttributesCmd.OPT_STREAM)) {
      ...
      WorkspaceShowCustomAttributesCmd.showCustomAttributes(workspaceSelectorList, null, key, client, config);
      ...
      SnapshotShowCustomAttributesCmd.getCustomAttributes(ssSelector, wsSelector, key, true, client, config);
      ...
      BaselineShowCustomAttributesCmd.getCustomAttributes(blSelector, compSelector, key, client, config);
      ...
      ComponentShowCustomAttributesCmd.getCustomAttributes(compSelector, key, client, config);
    } else {
      config.setEnableJSON(cli.hasOption(CommonOptions.OPT_JSON));
      ...
      VersionableShowCustomAttributesCmd.showCustomAttributes(paths, key, config);
    }
  }
}
